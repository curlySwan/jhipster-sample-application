  ...
  describe('Job Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Task query and add missing value', () => {
        ...
        const tasks: ITask[] = [{ id: 95887 }];
        job.tasks = tasks;

        const taskCollection: ITask[] = [{ id: 49592 }];
      ...
      it('Should call Employee query and add missing value', () => {
        const job: IJob = { id: 456 };
        const employee: IEmployee = { id: 11660 };
        job.employee = employee;

        const employeeCollection: IEmployee[] = [{ id: 83957 }];
      ...
      it('Should update editForm', () => {
        const job: IJob = { id: 456 };
        const tasks: ITask = { id: 69364 };
        job.tasks = [tasks];
        const employee: IEmployee = { id: 96146 };
        job.employee = employee;
