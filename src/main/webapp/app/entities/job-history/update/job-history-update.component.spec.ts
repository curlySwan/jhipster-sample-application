  ...
  describe('JobHistory Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call job query and add missing value', () => {
        ...
        const job: IJob = { id: 33952 };
        jobHistory.job = job;

        const jobCollection: IJob[] = [{ id: 29253 }];
      ...
      it('Should call department query and add missing value', () => {
        const jobHistory: IJobHistory = { id: 456 };
        const department: IDepartment = { id: 31819 };
        jobHistory.department = department;

        const departmentCollection: IDepartment[] = [{ id: 81463 }];
      ...
      it('Should call employee query and add missing value', () => {
        const jobHistory: IJobHistory = { id: 456 };
        const employee: IEmployee = { id: 92486 };
        jobHistory.employee = employee;

        const employeeCollection: IEmployee[] = [{ id: 13012 }];
      ...
      it('Should update editForm', () => {
        const jobHistory: IJobHistory = { id: 456 };
        const job: IJob = { id: 90352 };
        jobHistory.job = job;
        const department: IDepartment = { id: 24495 };
        jobHistory.department = department;
        const employee: IEmployee = { id: 3540 };
        jobHistory.employee = employee;
